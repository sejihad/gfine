...
text-gray-800 lg:block text-[17px] "
            ...
            <div className="lg:hidden flex items-center space-x-3">
              ...
              <button
                onClick={toggleMenu}
                className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-2.5 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center space-x-2"
        ...
        {/* Mobile Menu Overlay - NEW BUTTON STYLE */}
        <div
        ...
        >
          ...
          <div
            className={`absolute  left-0 right-0 bg-white rounded-t-3xl shadow-2xl transform transition-transform duration-500 ${
          ...
          >
            <div className="p-6">
              ...
              <button
                onClick={() => setIsOpen(false)}
                className="absolute top-4 right-4 text-gray-500 hover:text-gray-700 p-2 transition-colors"
              >
                <svg
                  width="24"
                  height="24"
              ...
              <div className="space-y-3">
                {[
                  ...
                  <Link
                    ...
                    to={item.path}
                    onClick={() => setIsOpen(false)}
                    className={`flex items-center space-x-4 w-full text-left p-4 rounded-2xl font-semibold transition-all duration-300 transform hover:scale-105 ${
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <Link
                  to="/login"
                  onClick={() => setIsOpen(false)}
                  className="block w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-4 px-6 rounded-2xl font-bold text-center shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
                >
